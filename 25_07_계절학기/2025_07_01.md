...
{large}일자별 강의 내용{/large}

- 7월 1일: 강의 소개, 수준 평가, 스타트업 개요, 노션과 이력서 형식
- 7월 2일: 이력서 작성 방법, 개발자 이력서 샘플 보기
...
# 라이캇이 가져갈 쿠키의 수를 리턴하는 함수를 완성해주세요.
...
{center}
{xlarge}# 벤처 창업 실무{/xlarge}
{/center}

---

{center}
{large}벤처 창업 실무 주요 내용{/large}
{/center}
...
{center}
{xlarge}# 1. 스타트업과 우리 이야기{/xlarge}
{/center}

---

{center}
{xlarge}스타트업: 신생 기업{/xlarge}
{/center}
