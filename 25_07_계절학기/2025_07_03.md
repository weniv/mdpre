...
{center}
{large}자격증은 어디까지 기입해야 할까요?{/center}

---

{center}
{large}사진은 어떤 사진까지 괜찮나요?{/center}

---

{center}
{large}첫번째 프로젝트는 어떤 프로젝트가 괜찮을까요?{/center}

---

{center}
{large}자기소개는 어떻게 써야 할까요?{/center}
...
{large}여러분의 성공적인 취업을 응원합니다!{/center}